...
type Character = {
    ...
    associationType: 'ASSOC_FATUI' | 'ASSOC_FONTAINE' | 'ASSOC_INAZUMA' | 'ASSOC_LIYUE' | 'ASSOC_MAINACTOR' | 'ASSOC_MONDSTADT' | 'ASSOC_NATLAN' | 'ASSOC_NODKRAI' | 'ASSOC_OMNI_SCOURGE' | 'ASSOC_RANGER' | 'ASSOC_SUMERU'; // enum;
